		...
		<table class="MainArea_Content" align="center" cellspacing="0" cellpadding="0">
			...
			<tbody id="TableData">
					...
					<tr>
						...
						<td>${c.foodtype }</td>
						<td>
							<a href="viewUpdate.do?id=${c.id }&type=${c.foodtype}" class="FunctionButton" style="color:#005294">更新</a> 
							<a href="delCuisine.do?id=${c.id}&type=${c.foodtype}" class="FunctionButton" style="color:#005294">删除</a>
						</td>
					</tr>
					</c:forEach>
