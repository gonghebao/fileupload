...
<div id="Head_2">
	...
	<div class="Head2_FunctionList" style="float: left">
		<a href="javascript:history.go(-1);"> <img
			src="style/images/Header_back.gif" width="24" height="24"
			style="margin-top: -8px;" /> <b>后退</b>
		</a> <a href="javascript:history.go(1);"> <img
			src="style/images/Header_forward.gif" width="24" height="24"
	...
	<div id="Head2_FunctionList">
		<!-- 
			 ...
			 -->
		<a href="javascript: window.location.reload();"> <img
			src="style/images/Header_refresh.gif" width="24" height="24"
			style="margin-top: -8px;" /> <b>刷新(IE、Chrome)</b>
		</a> <a href="javascript: window.location.reload();"> <img
			src="style/images/Header_refresh.gif" width="24" height="24"
			style="margin-top: -8px;" /> <b>刷新(Firefox)</b>
		</a>
	</div>
</div>
<div class="clear"></div>
